            ...
            <div class="row gx-0">
                <div class="col-lg-3 bg-dark d-none d-lg-block">
                    <a href="index.html"
                        ...
                        <h1 class="m-0 text-primary text-uppercase">Netha</h1>
                    </a>
                </div>
                <div class="col-lg-9">
                ...
                <div class="bg-white shadow" style="padding: 35px;">
                    <div class="row g-2">
                        <div class="col-md-10">
                            <div class="row g-2">
                                <div class="col-md-3">
                                    <div class="text" id="name" data-target-input="nearest">
                                        <input type="text" class="form-control" placeholder="masukan nama"
                                            data-target="name" data-toggle="name" />
                                    </div>
                                </div>
                                <div class="col-md-3">
